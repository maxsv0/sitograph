...
<body style="background: url(/content/images/adminmcg/bg.gif) repeat-x #FFFFFF;padding-top:10px;">
...
<tr>
	...
	<img src="/content/images/adminmcg/logo-new.png">
	</td>
	<td>
	...
	<tr>
		<td style="padding-bottom: 100px;"><img src="/content/images/adminmcg/index_text.png"></td>
	</tr>
	<tr>
...
{/if}
	...
	<tr>
		<td style="background: url(/content/images/adminmcg/login_plain.png) 0 0 no-repeat; padding: 1px 3px 5px 3px;" height="206">
...
<form action="/admin/login/" method="POST" id="login_form">
		...
		<tr>
			<td><input type="image" style="height:30px;" src="/content/images/adminmcg/btn_login.gif"></td>
		</tr>
		</table>
