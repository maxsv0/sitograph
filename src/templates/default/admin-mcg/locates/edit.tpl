...
{include "$themePath/admin/field-form.tpl" form_id="form" item_type=$itemField.type item_id=$itemField.field_name item_name=$itemField.name value=$itemField.value}
