<p class="lead"><a href="{$home_url}robots.txt" target="_blank" style="font-size: 16px;">Robots.txt <span class="glyphicon glyphicon-new-window"></span></a></p>
...
<div class="form-group">
  ...
  <textarea class="form-control" rows="15" name="form_robots_content">{$mcg_robots}</textarea>
</div>
