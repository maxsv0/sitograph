<fieldset class="legend">
  <legend class="legend">{_t("title.upload_files")} to <i>{$upload_path}</i></legend>

  <form class="form-inline" action="/api/uploadfile/" target="_blank" name="uploadForm" method="post" enctype="multipart/form-data">
