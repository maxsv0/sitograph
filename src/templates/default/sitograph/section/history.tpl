...
<div class="alert alert-warning">
	<div class="row">
		...
		<div class="col-xs-11" style="padding-left:0;">
			...
			<p>
				<a href="/admin/?section=config#DEBUG_LOG">{_t("admin.config")} (DEBUG_LOG)</a>, <a href="/admin/?section=config#DEBUG">{_t("admin.config")} (DEBUG)</a>.
			</p>
		</div>
	</div>
</div>
{else}
	...
	<p>
		<a class="btn btn-danger" href="/admin/?section=history&truncate_log">Truncate log file</a>
