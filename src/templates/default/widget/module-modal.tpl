        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-xs-6 col-sm-5">
                    <img class="img-thumbnail module-preview">
                </div>
                ...
                <div class="col-xs-6 col-sm-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-right">
                            <p class="module-star-rating"></p>
                            <p class="module-reviews"></p>
                            <p class="module-downloads"></p>

                        </div>
                    </div>
                    <p class="module-price col-xs-2 pull-right text-center"></p>
